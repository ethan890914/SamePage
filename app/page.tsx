...
const activities = [
  { name: 'Converge', detail: 'Find the same word', tone: 'pink' },
  { name: 'Pattern Race', detail: 'Think fast, type faster', tone: 'cyan' },
  { name: 'Photo Booth', detail: 'Make a tiny memory', tone: 'yellow' },
] as const;
    ...
    <main className="pixel-world min-h-screen px-4 py-6 text-foreground sm:px-7 lg:px-10">
      <div className="mx-auto max-w-6xl">
        <header className="mb-6 flex items-center justify-between gap-4">
          ...
          <PixelStatus label="Arcade online" />
        </header>
        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(340px,.85fr)]">
          ...
          >
            ...
            >
              ...
              >
                <Gamepad2 size={19} />{' '}
                {mode === 'create' ? 'Create arcade' : 'Join arcade'}
              </PixelButton>
            </form>
